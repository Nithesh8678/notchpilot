...
NotchPilot modification (2026): assign checkpoint tensors directly during
load_state_dict to avoid copying a second resident set of model weights.
Original source: Laya v0.3.7, Apache-2.0, Convai Innovations.
"""
import json
import os
import warnings
...
class Agent:
    ...
    def __init__(
        ...
        del weights
        # Preserve upstream float32 inference while releasing half-precision mmap
        # references as tensors are promoted, instead of keeping two full copies.
        self.model.float()
