...
@MainActor final class LocalSettings: ObservableObject {
  ...
  @Published var reducedAnimations: Bool {
    didSet { defaults.set(reducedAnimations, forKey: "reducedAnimations") }
  }
  ...
  init() {
    defaults.register(defaults: [
      "hotkeyCode": 49, "hotkeyModifiers": optionKey, "dryRun": true, "language": "en-US",
      "retention": 30.0,
    ])
    ...
    lowResource = defaults.bool(forKey: "lowResource")
    reducedAnimations = defaults.bool(forKey: "reducedAnimations")
    confirmAll = defaults.bool(forKey: "confirmAll")
    language = defaults.string(forKey: "language") ?? "en-US"
    retention = defaults.double(forKey: "retention")
